...
کد منبع این ربات به‌صورت عمومی در گیت‌هاب منتشر شده و هر کسی می‌تواند آن را بازبینی کند:

🔗 https://github.com/reymaleki-droid/revolution-bot
...
🌹 گل بیاورید، لبخند بزنید، از پلیس تشکر کنید!

برای مشاهده تجمعات در شهر خود، یک کشور انتخاب کنید:""",
...
به امید دیدار در تجمعات! 🦁☀️""",
    ...
    'flower_campaign_intro': """🌹 *کمپین تقدیم گل به پلیس و مردم*

ما ایرانیان مغرور و مهربان هستیم. با تقدیم گل نشان می‌دهیم که پیام ما عشق و صلح است، نه نفرت.

*چگونه کار می‌کند:*
1️⃣ قبل از تجمع، دسته گل یا شاخه گل تهیه کنید 🌹🌻🌷
2️⃣ به مأموران پلیس گل هدیه دهید و از آنها بابت حفاظت تشکر کنید 👮
3️⃣ به رهگذران و تماشاچیان گل بدهید و لبخند بزنید 😊
4️⃣ عکس یا ویدیوی لحظه تقدیم گل را ارسال کنید 📸🎬

*ایده‌های بیشتر:*
🍫 شکلات و شیرینی ایرانی هدیه دهید
📖 بروشور درباره وضعیت ایران همراه گل بدهید
🤝 دست بدهید و بگویید: Thank you for protecting our right to protest
☕ قهوه یا چای برای پلیس ببرید

🎁 *پاداش:* ۱۵ امتیاز برای هر عکس یا ویدیو

عکس یا ویدیوی تقدیم گل خود را ارسال کنید:""",
...
*چگونه کار می‌کند:*
1️⃣ عکس یا ویدیوی "قبل" از محل آشفته بگیرید
2️⃣ محل را پاکسازی کنید
3️⃣ عکس یا ویدیوی "بعد" از محل تمیز بگیرید
4️⃣ هر دو را ارسال کنید (عکس یا ویدیو)

🎁 *پاداش:* 20 امتیاز + نشان ویژه

آیا آماده‌اید؟""",

    'cleanup_photo_before': """📸 *عکس یا ویدیوی "قبل" را ارسال کنید*

لطفاً عکس یا ویدیویی از محل تجمعات قبل از پاکسازی ارسال کنید.

این نشان می‌دهد که محل نیاز به تمیز کردن دارد.""",

    'cleanup_photo_after': """📸 *عالی! حالا عکس یا ویدیوی "بعد" را ارسال کنید*

عکس یا ویدیویی از همان محل بعد از پاکسازی ارسال کنید.

این تلاش شما را نشان خواهد داد! 🧹✨""",
...
• تخریب اموال
• پرچم جمهوری اسلامی
• پرچم سازمان تروریستی مجاهدین خلق (MEK)
