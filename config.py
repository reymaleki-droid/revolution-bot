...
POINTS = {
    ...
    'placard_submitted': 20,
}

# Language display names for placard categories
LANGUAGE_NAMES = {
    'en': '🇬🇧 English',
    'de': '🇩🇪 Deutsch',
    'fr': '🇫🇷 Français',
...
- ارجاع فایل پلاکاردهای تأییدشده (شناسه فایل تلگرام، عنوان، کشور و زبان)
- تصاویر و ویدیوهای تقدیم گل و پاکسازی خیابان در کانال آرشیو تلگرام
...
کشوری را برای مشاهده تجمعات انتخاب کنید:""",
    ...
    'placards_intro': """🪧 *پلاکاردهای قابل چاپ*

اینجا می‌توانید پلاکاردهای آماده برای تجمعات را دانلود و چاپ کنید.

همچنین می‌توانید طرح‌های خود را برای بررسی ارسال کنید.

🌍 یک گزینه انتخاب کنید:""",

    'placards_select_country': """🌍 *انتخاب کشور*

کشور مورد نظر را انتخاب کنید:""",

    'placards_select_language': """🗣️ *انتخاب زبان*

زبان پلاکارد را انتخاب کنید:""",

    'placard_submit_intro': """➕ *ارسال طرح پلاکارد*

شما می‌توانید طرح پلاکارد خود را برای بررسی ادمین ارسال کنید.

📌 لطفاً ابتدا کشور مقصد را انتخاب کنید:""",

    'placard_submit_title': """📝 *عنوان پلاکارد*

لطفاً یک عنوان کوتاه برای پلاکارد وارد کنید:""",

    'placard_submit_file': """📎 *ارسال فایل*

حالا فایل پلاکارد خود را ارسال کنید (PDF، تصویر، یا هر فرمت قابل چاپ):""",

    'placard_submitted': """✅ *طرح شما دریافت شد!*

طرح پلاکارد شما برای بررسی به مدیران ارسال شد.

🔐 شناسه ناشناس: `{token}`

در صورت تایید، پلاکارد شما در بخش دانلود قرار خواهد گرفت.

🎁 *+{points} امتیاز* پس از تایید دریافت خواهید کرد.""",

    'no_placards': """📭 هنوز پلاکاردی برای این بخش ثبت نشده است.

شما می‌توانید اولین طرح را ارسال کنید! 🎨""",
}
